...
<body>
    <div class="auth-container">
        ...
        <form class="needs-validation" novalidate action="{{route('Emp.check')}}" method='post' enctype="multipart/form-data">
        @csrf
        ...
        <div class="row g-4">  
                        ...
                        <div class="text-center mt-3">
                            <p> Don't have an account? <a href="{{route('Emp.register')}}">Register here</a></p>
                        </div>
                    </div>
                </div>
            </div>
